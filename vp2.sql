...
--
-- Host: localhost:3306
-- Generation Time: 07.04.2019 klo 02:30
...
--
-- Rakenne taululle `mökki`
--

CREATE TABLE `mökki` (
  `nimi` varchar(50) NOT NULL,
  `osoite` varchar(50) NOT NULL,
  `mökki_id` int(11) NOT NULL,
...
--
-- Rakenne taululle `mökki_varaus`
--

CREATE TABLE `mökki_varaus` (
  `mökkivaraus_id` int(11) NOT NULL,
  `varausmökki_id` int(11) NOT NULL,
  `lkm` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `palvelu_tyypit` (`tyyppiID`, `nimi`, `kuvaus`) VALUES
(1, 'Testimökki', '');
...
INSERT INTO `varauksen_palvelut` (`varaus_id`, `palvelu_id`) VALUES
(1, 1);
...
INSERT INTO `varaus` (`varaus_id`, `asiakas_id`, `toimipiste_id`, `varattu_pvm`, `vahvistus_pvm`, `varattu_alkupvm`, `varattu_loppupvm`, `varausmökki_id`) VALUES
(1, 1, 1, '2019-04-03 00:00:00', '2019-04-04 00:00:00', '2019-04-07 00:00:00', '2019-04-13 00:00:00', 0);
...
--
-- Indexes for table `mökki`
--
ALTER TABLE `mökki`
  ADD PRIMARY KEY (`mökki_id`);

--
-- Indexes for table `mökki_varaus`
--
ALTER TABLE `mökki_varaus`
  ADD PRIMARY KEY (`mökkivaraus_id`,`varausmökki_id`),
  ADD KEY `varaus_liitos` (`varausmökki_id`);
...
--
-- Rajoitteet taululle `mökki_varaus`
--
ALTER TABLE `mökki_varaus`
  ADD CONSTRAINT `mökki_liitos` FOREIGN KEY (`mökkivaraus_id`) REFERENCES `mökki` (`mökki_id`),
  ADD CONSTRAINT `varaus_liitos` FOREIGN KEY (`varausmökki_id`) REFERENCES `varaus` (`varaus_id`);
